...
export const mockSources: Source[] = [
  {
    id: 'jira-1',
    type: 'Jira',
    title: 'DMS-124: Implement System Architecture for DMS',
    url: 'https://jira.ncss.gov.sg/browse/DMS-124',
    content: 'The system architecture for DMS (Donor Management System) involves a microservices approach using Node.js and React. The database is PostgreSQL. Deployment is on Cloud Run.',
    lastUpdated: '2026-03-15',
  },
  {
    id: 'jira-dms-2',
    type: 'Jira',
    title: 'DMS-205: Sprint 12 Blockers',
    url: 'https://jira.ncss.gov.sg/browse/DMS-205',
  ...
  },
  {
    id: 'conf-1',
    type: 'Confluence',
    title: 'DMS System Architecture Design',
    url: 'https://confluence.ncss.gov.sg/display/DMS/Architecture',
  ...
  },
  {
    id: 'conf-4',
    type: 'Confluence',
    title: 'DMS User Manual - Release 1.0',
    url: 'https://confluence.ncss.gov.sg/display/DMS/User+Manual',
    content: 'Comprehensive guide for case workers using the DMS system. Covers case creation, assessment workflows, and reporting modules.',
    lastUpdated: '2026-04-02',
  },
  {
    id: 'gitlab-1',
    type: 'GitLab',
    title: 'dms-frontend / README.md',
    url: 'https://gitlab.ncss.gov.sg/dms/frontend/-/blob/main/README.md',
    content: 'Frontend project for DMS. Built with Vite, React, and Tailwind CSS. CI/CD pipeline is configured to deploy to development environment on every merge to main.',
    lastUpdated: '2026-04-05',
  },
  {
    id: 'gitlab-dms-2',
    type: 'GitLab',
    title: 'dms-backend / Pipeline Status',
    url: 'https://gitlab.ncss.gov.sg/dms/backend/-/pipelines',
  ...
  },
  {
    id: 'gitlab-sec-1',
    type: 'GitLab',
    title: 'Security Scan: Critical Vulnerabilities in dms-auth-service',
    url: 'https://gitlab.ncss.gov.sg/dms/auth-service/-/security/vulnerabilities',
  ...
  },
  {
    ...
    url: 'https://confluence.ncss.gov.sg/display/DMS/Notification+Spec',
  ...
  },
  {
    ...
    content: 'Tickets included: DMS-124, DMS-205. Status: All testing completed in UAT. Pending CAB approval.',
    lastUpdated: '2026-04-09',
  },
  {
    id: 'gitlab-mr-1',
    ...
    url: 'https://gitlab.ncss.gov.sg/dms/frontend/-/merge_requests/452',
